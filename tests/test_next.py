...
def test_generate_multiple_next_6():
...
def test_generate_multiple_next_7():
...
def test_generate_multiple_next_8():
...
def test_generate_multiple_next_9():
    ...
    """
    cron = "30 9 3W * ? *"
    expected_list = ["2020-08-03 09:30:00+00:00", "2020-09-03 09:30:00+00:00", "2020-10-02 09:30:00+00:00"]
...
def test_generate_multiple_next_10():
    """At 09:30 AM, on the weekday nearest day 3 of the month
        cron(Minutes Hours Day-of-month Month Day-of-week Year)
        W ==>>This character is used to specify the weekday (Monday-Friday) nearest the given day.
    :return:
...
def test_generate_multiple_next_11():
    """At 09:30 AM, on the weekday nearest day 3 of the month
        cron(Minutes Hours Day-of-month Month Day-of-week Year)
        W ==>>This character is used to specify the weekday (Monday-Friday) nearest the given day.
    :return:
    """
    cron = "0 0 31W * ? 2020"
    expected_list = ["2020-05-29 00:00:00+00:00", "2020-07-31 00:00:00+00:00", "2020-08-31 00:00:00+00:00"]
...
def test_generate_multiple_next_12():
    """At 09:30 AM, on the weekday nearest day 3 of the month
        cron(Minutes Hours Day-of-month Month Day-of-week Year)
        W ==>>This character is used to specify the weekday (Monday-Friday) nearest the given day.
    :return:
...
def test_generate_multiple_next_13():
...
def test_generate_multiple_next_14():
    """Every minute between 10:00 PM and 10:/5 PM, on day 09 of the month, only in May,
        only in 2020, 2021, and 2022
